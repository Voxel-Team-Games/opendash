...
class OpenDashGame : ApplicationAdapter() {
    ...
    private lateinit var level: com.voxelteamgames.opendash.game.Level
    ...
    override fun create() {
        ...
        println("OpenDash iniciado com LibGDX!")
    ...
    override fun resize(
        ...
        println(
            "OpenDash redimensionado: ${width}x$height"
        )
    }
